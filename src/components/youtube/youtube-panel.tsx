  ...
  return (
    <PanelWrapper title="YouTube Channels" accent="magenta">
      {loading ? (
        ...
        <div className="rounded-md border border-apex-amber/30 bg-apex-amber/5 p-4">
          <p className="font-mono text-sm text-apex-amber">{error}</p>
          <p className="mt-1 text-xs text-muted-foreground">
            Data is generated by OpenClaw daily at 4 AM ET
          </p>
        </div>
      ) : (
